...
namespace Astral.Canvas
{
    ...
    public struct Plane : IEquatable<Plane>
    {
        ...
        /// </summary>
        /// <param name="pointOnPlane">A point the created Plane should contain.</param>
        ...
        public Plane Normalize()
        {
            ...
            {
                float f = Normal.X * Normal.X + Normal.Y * Normal.Y + Normal.Z * Normal.Z;
        ...
        public bool Intersects(BoundingBox box)
        {
            ...
            Vector3 extents = box.Max - center;
            float intervalRadius = extents.X * Mathf.Abs(Normal.X) + extents.Y * Mathf.Abs(Normal.Y) + extents.Z * Mathf.Abs(Normal.Z);
            return -intervalRadius <= Vector3.Dot(Normal, center) - D;
            //float distBoxCenter = Vector3.Dot(Normal, center) - D;
            //return Mathf.Abs(distBoxCenter) <= intervalRadius;
        }
