...
void Initialize()
{
    ...
    char *fileData = ReadFile("E:/Internship/Astral.Canvas/c-examples/Triangle/bin/Debug/Triangle.shaderobj");
    ...
    int errorCode = AstralCanvasShader_FromString(fileData, &shader);
